...
public final class ActivityView: UIView {
    ...
    fileprivate static let points: [CGPoint] = {
        var points: [CGPoint] = Array(repeating: CGPoint.zero, count: 20)
        ...
        points[4] = CGPoint(x: 0.20928571428571, y: 0.16642857142857)
        points[5] = CGPoint(x: 0.79071428571429, y: 0.16642857142857)
        points[6] = CGPoint(x: 0.5, y: 0.66607142857143)
        points[7] = CGPoint(x: 0.20928571428571, y: 0.16642857142857)
        points[8] = CGPoint(x: 0.79071428571429, y: 0.16642857142857)
    ...
    public var color = UIColor(red:1.00, green:0.07, blue:0.18, alpha:1.00) {
        didSet {
